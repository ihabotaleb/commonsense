...
def get_bounded_image_downsample(frame, ref, bounds, factor):
    return frame[bounds.y:bounds.y+bounds.h:factor, bounds.x:bounds.x+bounds.w:factor], ref[bounds.y:bounds.y+bounds.h:factor, bounds.x:bounds.x+bounds.w:factor]